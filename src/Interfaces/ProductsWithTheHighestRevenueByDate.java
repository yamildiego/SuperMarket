...
public class ProductsWithTheHighestRevenueByDate extends javax.swing.JDialog {

        private Product product;
        public static final int RET_CANCEL = 0;
        public static final int RET_OK = 1;

        public ProductsWithTheHighestRevenueByDate(java.awt.Frame parent, boolean modal) {
                super(parent, modal);
                initComponents();
        ...
        private void initComponents() {
                ...
                setTitle("Products With The Highest Revenue By Date");
                setResizable(false);
